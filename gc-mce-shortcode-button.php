...
if(!defined('ABSPATH')) {die('direct access can not possoble');}
	...
	class Gc_mce_button_adl
	{
		...
		public function adl_gc_list_ajax() {
			...
			$posts = $this->posts( 'adl-shortcode' ); // change 'post' if you need posts list
...
if(class_exists("Gc_mce_button_adl")) {
	$sp_mce_btn = new Gc_mce_button_adl();
	$sp_mce_btn->init();
}
