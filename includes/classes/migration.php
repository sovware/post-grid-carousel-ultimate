            ...
            foreach( $old_posts as $old_post ) {
                ...
                if( ! empty( $get_meta['g_theme'] ) ) {
                    ...
                    if( 'grid' == $get_meta['layout'] ) {
                        ...
                        $new_meta['display_header_title']   = ! empty( $get_meta['g_title_option'] ) ? $get_meta['g_title_option'] : '';
                        $new_meta['header_title']           = ! empty( $get_meta['g_title'] ) ? $get_meta['g_title'] : '';
                        
                    }elseif( 'carousel' == $get_meta['layout'] ) {
                        $new_meta['theme'] = 'theme-' . $carousel_theme_number;
                        $new_meta['display_header_title']   = ! empty( $get_meta['c_title_option'] ) ? $get_meta['c_title_option'] : '';
                        $new_meta['header_title']           = ! empty( $get_meta['c_title'] ) ? $get_meta['c_title'] : '';
                    }
