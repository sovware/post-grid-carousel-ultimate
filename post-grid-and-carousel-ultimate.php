...
if( ! in_array('post-grid-carousel-ultimate-pro/post-grid-and-carousel-ultimate.php', apply_filters('active_plugins', get_option('active_plugins')) ) ) {
    ...
    function pgcu_delete_old_version() {
        deactivate_plugins('post-grid-carousel-ultimate-pro/post-grid-and-carousel-ultimate.php');
        delete_plugins( array('post-grid-carousel-ultimate-pro/post-grid-and-carousel-ultimate.php') );
    }
    add_action( 'admin_init', 'pgcu_delete_old_version' );
}